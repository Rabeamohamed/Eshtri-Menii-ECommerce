...
namespace ECom.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260212153851_SeedingDatainDeliveryMethodTable")]
    partial class SeedingDatainDeliveryMethodTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECom.Core.DTO.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECom.Core.DTO.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ECom.Core.DTO.Address", b =>
                {
                    b.HasOne("ECom.Core.DTO.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("ECom.Core.DTO.Address", "AppUserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECom.Core.DTO.AppUser", null)
                        .WithMany()
